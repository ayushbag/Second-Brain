...
const Register = () => {
  return (
    <section className="flex items-center justify-center mx-auto text-white h-screen bg-zinc-950">
      ...
      <div className="lg:w-4/5 text-center rounded-3xl hidden lg:block lg:bg-gradient-to-br lg:from-violet-800 lg:via-violet-600 lg:to-violet-300 transition-all duration-300 h-full bg-cover bg-center" style={{ backgroundImage: "url('/LoginBackground.jpg')" }}>
      </div>
    </section>
  );
};
