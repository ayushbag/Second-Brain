...
const GoogleIcon = ():ReactElement => {
  return (
	<svg id="Capa_1" style={{ background: "new 0 0 150 150" }} version="1.1" viewBox="0 0 150 150" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
	  <style type="text/css">
		{`
		  .st0{fill:#1A73E8;}
		  .st1{fill:#EA4335;}
